...
/* gl3w api */
ENGINE_API int gl3wInit(void);
ENGINE_API int gl3wInit2(GL3WGetProcAddressProc proc);
ENGINE_API int gl3wIsSupported(int major, int minor);
ENGINE_API GL3WglProc gl3wGetProcAddress(const char *proc);
...
extern ENGINE_API union GL3WProcs gl3wProcs;
